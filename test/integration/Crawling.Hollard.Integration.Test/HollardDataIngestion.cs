...
{
    public class DataIngestion : IClassFixture<HollardTestFixture>
    {
        private readonly HollardTestFixture fixture;
        private readonly ITestOutputHelper output;

        public DataIngestion(HollardTestFixture fixture, ITestOutputHelper output)
        {
