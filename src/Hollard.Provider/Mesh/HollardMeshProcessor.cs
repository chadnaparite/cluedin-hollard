...
{
    public class Hollard_Command_MeshProcessor : BaseMeshProcessor
    {
        public Hollard_Command_MeshProcessor(ApplicationContext appContext)
            : base(appContext)
        {
        }

        public override Guid GetProviderId() =>
          HollardConstants.ProviderId;
